...
class _OrderDetailScreenState extends State<OrderDetailScreen> {
  ...
  //Only for Admin
  void changedOrderStatus(int status) {
    adminServices.changedOrderStatus(
        context: context,
        status: status + 1,
        order: widget.order,
        onSuccess: () {
                  ...
                  child: Stepper(
                    ...
                    controlsBuilder: (context, details) {
                      if (user.type == 'admin') {
                        return CustomButton(
                            text: 'Done',
                            onTap: () =>
                                changedOrderStatus(details.currentStep));
                      }
                    ...
                    steps: [
                      ...
                      Step(
                        ...
                        content: const Text(
                            'Your order is delieverd, you are yet to sign.'),
                      ...
                      Step(
                        ...
                        content: const Text(
                            'Your order is delieverd and signed by you.'),
