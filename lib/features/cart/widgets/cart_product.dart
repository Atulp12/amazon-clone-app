...
import 'package:amazon_clone_app/features/product_detail/screens/services/product_detail_services.dart';
...
class _CartProductState extends State<CartProduct> {
  ...
  Widget build(BuildContext context) {
    final productCart = Provider.of<UserProvider>(context, listen: false)
        .user
        .cart[widget.index];
